...
NAME = rogue 
SCRS = curse.c debug.c mensaje.c menu.c mapa.c pantalla.c objeto.c jugador.c item.c ia.c enemigo.c fantasma.c nivel.c regla.c memoria.c portada.c rogue.c
